...
public final class MessageConstant {
    ...
    public static final String USER_NOT_LOGIN = "USER_NOT_LOGIN"; // "用户未登录"
    ...
    public static final String SHOPPING_CART_IS_NULL = "SHOPPING_CART_IS_NULL"; // "购物车数据为空，不能下单"
    public static final String ADDRESS_BOOK_IS_NULL = "ADDRESS_BOOK_IS_NULL"; // "用户地址为空，不能下单"
    public static final String LOGIN_FAILED = "LOGIN_FAILED"; // "登录失败"
    public static final String UPLOAD_FAILED = "UPLOAD_FAILED"; // "文件上传失败"
    public static final String SETMEAL_ENABLE_FAILED = "SETMEAL_ENABLE_FAILED"; // "套餐内包含未启售菜品，无法启售"
